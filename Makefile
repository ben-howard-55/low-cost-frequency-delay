...
BSP_ROOT_DIR := //files.auckland.ac.nz/myhome/Documents/GitHub/LCFR2_bsp/
...
QUARTUS_PROJECT_DIR := //files.auckland.ac.nz/myhome/Documents/GitHub/low-cost-frequency-relay/SOPC_files/
